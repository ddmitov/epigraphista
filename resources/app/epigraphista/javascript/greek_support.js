...
function toggleAdditionalKeyboard(target) {
  ...
  "</div>" +
  "<div class='container text-center'>" +
    "<input type='button' value='Α' onClick=\"javascript:insertLetter('" + target + "', 'Α')\" class='btn btn-success btn-xs btn-letters'>" +
    "<input type='button' value='Σ' onClick=\"javascript:insertLetter('" + target + "', 'Σ')\" class='btn btn-success btn-xs btn-letters'>" +
    "<input type='button' value='Δ' onClick=\"javascript:insertLetter('" + target + "', 'Δ')\" class='btn btn-success btn-xs btn-letters'>" +
    "<input type='button' value='Φ' onClick=\"javascript:insertLetter('" + target + "', 'Φ')\" class='btn btn-success btn-xs btn-letters'>" +
    "<input type='button' value='Γ' onClick=\"javascript:insertLetter('" + target + "', 'Γ')\" class='btn btn-success btn-xs btn-letters'>" +
    "<input type='button' value='Η' onClick=\"javascript:insertLetter('" + target + "', 'Η')\" class='btn btn-success btn-xs btn-letters'>" +
    "<input type='button' value='Σ' onClick=\"javascript:insertLetter('" + target + "', 'Σ')\" class='btn btn-success btn-xs btn-letters'>" +
    "<input type='button' value='Κ' onClick=\"javascript:insertLetter('" + target + "', 'Κ')\" class='btn btn-success btn-xs btn-letters'>" +
    "<input type='button' value='Λ' onClick=\"javascript:insertLetter('" + target + "', 'Λ')\" class='btn btn-success btn-xs btn-letters'>" +
  "</div>" +
  "<div class='container text-center'>" +
    "<input type='button' value='α' onClick=\"javascript:insertLetter('" + target + "', 'α')\" class='btn btn-success btn-xs btn-letters'>" +
    "<input type='button' value='σ' onClick=\"javascript:insertLetter('" + target + "', 'σ')\" class='btn btn-success btn-xs btn-letters'>" +
    ...
    "<input type='button' value='κ' onClick=\"javascript:insertLetter('" + target + "', 'κ')\" class='btn btn-success btn-xs btn-letters'>" +
    "<input type='button' value='λ' onClick=\"javascript:insertLetter('" + target + "', 'λ')\" class='btn btn-success btn-xs btn-letters'>" +
    "<input type='button' value='·' onClick=\"javascript:insertLetter('" + target + "', '·')\" class='btn btn-success btn-xs btn-letters'>" +
  "</div>" +
  "<div class='container text-center'>" +
    "<input type='button' value='Ζ' onClick=\"javascript:insertLetter('" + target + "', 'Ζ')\" class='btn btn-success btn-xs btn-letters'>" +
    "<input type='button' value='Χ' onClick=\"javascript:insertLetter('" + target + "', 'Χ')\" class='btn btn-success btn-xs btn-letters'>" +
    "<input type='button' value='Ξ' onClick=\"javascript:insertLetter('" + target + "', 'Ξ')\" class='btn btn-success btn-xs btn-letters'>" +
    "<input type='button' value='Ϝ' onClick=\"javascript:insertLetter('" + target + "', 'Ϝ')\" class='btn btn-success btn-xs btn-letters'>" +
    "<input type='button' value='Β' onClick=\"javascript:insertLetter('" + target + "', 'Β')\" class='btn btn-success btn-xs btn-letters'>" +
    "<input type='button' value='Ν' onClick=\"javascript:insertLetter('" + target + "', 'Ν')\" class='btn btn-success btn-xs btn-letters'>" +
    "<input type='button' value='Μ' onClick=\"javascript:insertLetter('" + target + "', 'Μ')\" class='btn btn-success btn-xs btn-letters'>" +
  "</div>" +
  "<div class='container text-center'>" +
    "<input type='button' value='ζ' onClick=\"javascript:insertLetter('" + target + "', 'ζ')\" class='btn btn-success btn-xs btn-letters'>" +
    "<input type='button' value='χ' onClick=\"javascript:insertLetter('" + target + "', 'χ')\" class='btn btn-success btn-xs btn-letters'>" +
