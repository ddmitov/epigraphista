...
TS.singleSquareBracketAlertMessage = "Single square bracket is found within the text of the inscription!<br>" +
								"Please, correct the text!";
...
TS.elementRemovalConfirmMessage = "This element contains text and it will be lost!<br>" +
...
TS.closeConfirmation = "Inscription data was entered, but not saved and it is going to be lost!<br>" +
						"Are you sure you want to close the program?";

TS.loadAnotherPageConfirmation = "Inscription data was entered, but not saved and it is going to be lost!<br>" +
