...
TS.singleSquareBracketAlertMessage =
  'Намерена е единична квадратна скоба в текста на надписа!\n' +
  'Моля, поправете въведения текст!';
TS.fileSavedMessage = 'Файлът е записан успешно!';
TS.closeConfirmation =
  'Попълненият текст не е записан и ще бъде загубен!\n' +
...
TS.elementRemovalConfirmMessage =
  'В този елемент е попълнен текст и той ще бъде загубен!\n' +
...
TS.contextMenuCutLabel = 'Изрежи';
TS.contextMenuCopyLabel = 'Копирай';
